...
/**
 * convert_nmbr - converter function, a clone of itoa
 * @num: numero.
 * @base: base.
 * @flags: argument of flags.
 * Return: string.
 */
char *convert_nmbr(long int num, int base, int flags)
{
	static char *array;
 ...
 * @buf: address of the string to modifie.
 * Return: 0;
 */
